...
public abstract class BlockEntityEMCLink$ItemHandlerMixin {
    @Shadow
    @Final
    ...
    @ModifyExpressionValue(method = {"insertItem", "extractItemInternal"}, at = @At(value = "MIXINEXTRAS:EXPRESSION", ordinal = 0))
    ...
    @Definition(id = "player", local = @Local(type = ServerPlayer.class))
    @Expression("player != null")
    @ModifyExpressionValue(method = "extractItemInternal", at = @At("MIXINEXTRAS:EXPRESSION"))
